...
public class AzureMobileServiceAdapter {
    private String mMobileBackendUrl = "https://techydukhaan.azurewebsites.net";
    ...
    public static void Initialize(Context context) {
        if (mInstance == null) {
            ...
            throw new IllegalStateException("AzureMobileServiceAdapter is already initialized");
        }
    }

    public static AzureMobileServiceAdapter getInstance() {
        if (mInstance == null) {
            throw new IllegalStateException("AzureMobileServiceAdapter is not initialized");
        }
        return mInstance;
    }
